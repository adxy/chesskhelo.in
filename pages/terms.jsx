...
export default function Terms() {
  return (
    <TermsContainer>
      <h1>Terms & Conditions for ChessKhelo</h1>

      <p>Welcome to ChessKhelo!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of ChessKhelo's Website, located at https://chesskhelo.in.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use ChessKhelo if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing ChessKhelo, you agreed to use
        cookies in agreement with the ChessKhelo's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, ChessKhelo and/or its licensors own the
        intellectual property rights for all material on ChessKhelo. All
        intellectual property rights are reserved. You may access this from
        ChessKhelo for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from ChessKhelo</li>
        <li>Sell, rent or sub-license material from ChessKhelo</li>
        <li>Reproduce, duplicate or copy material from ChessKhelo</li>
        <li>Redistribute content from ChessKhelo</li>
      </ul>
      ...
      <p>
        ...
        ChessKhelo does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of ChessKhelo,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, ChessKhelo shall not be
      ...
      <p>
        ChessKhelo reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant ChessKhelo a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of ChessKhelo; and (d) the link is
      ...
      <p>
        ...
        e-mail to ChessKhelo. Please include your name, your organization name,
      ...
      <p>
        No use of ChessKhelo's logo or other artwork will be allowed for linking
