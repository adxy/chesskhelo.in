...
export default function PrivacyPolicy() {
  return (
    <PrivacyPolicyContainer>
      <h1>Privacy Policy for ChessKhelo</h1>

      <p>
        At https://chesskhelo.in, accessible from https://chesskhelo.in, one of
        ...
        https://chesskhelo.in and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in https://chesskhelo.in. This policy is not
      ...
      <p>
        https://chesskhelo.in follows a standard procedure of using log files.
      ...
      <p>
        Like any other website, https://chesskhelo.in uses 'cookies'. These
      ...
      <p>
        ...
        advertising partners of https://chesskhelo.in.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on https://chesskhelo.in, which are
      ...
      <p>
        Note that https://chesskhelo.in has no access to or control over these
      ...
      <p>
        https://chesskhelo.in's Privacy Policy does not apply to other
      ...
      <p>
        https://chesskhelo.in does not knowingly collect any Personal
